...
class DecoderLayer(nn.Module):
    ...
    def forward(self, trg, src):
        ...
        trg_1 = trg
        trg,_ = self.sa(trg, trg, trg)
        trg = self.ln(trg_1 + self.do(trg))
        
        trg_2 = trg
        trg, attention = self.ea(trg, src, src)
...
class Predictor(nn.Module):
    ...
    def forward(self, compound, adj, protein):
        ...
        out,attention = self.decoder(compound, enc_src)
        # out = [batch size, 2]
